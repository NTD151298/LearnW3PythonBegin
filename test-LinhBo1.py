...
# Vẽ đơn vị LinhBo1 lên mặt phẳng game
game_surface.blit(LinhBo1, (100, 100))
game_surface.blit(LinhBo2, (200, 100))
...
while time.time() - start_time < 100:
    ...
    # Vẽ mặt phẳng game lên cửa sổ
    window.blit(game_surface, (0, 0))

    # Cập nhật cửa sổ Pygame
    pygame.display.update()

    # Tạm dừng chương trình trong 1/60 giây để giảm tải CPU
    time.sleep(1/60)
